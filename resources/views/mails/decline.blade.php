                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">YOUR REQUEST TO OPEN A VIMFILE ACCOUNT IS DECLINED</h2>
...
<br />We regret to inform you that the request to open a vimfile account is declined.</b> <br><br>Kindly <a href="{{route('Contact')}}">contact the admin</a> using the contact form if you think the decision should be reviewed.<br><br> <a href="{{route('Contact')}}" style="color: navy; font-weight: bold;">Click here to contact Admin</a><br><br> Thank you for choosing VIM File
<br /><br />
