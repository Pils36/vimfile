                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">PASSWORD CHANGE</h2>
...
<br />Your password has been successfully changed by you.<br><br> <b>Below are your details to next login:</b>
<br /><br />
Name: {{$maildata->name}} <br><br>

E-mail: {{$maildata->email}} <br><br>

Password: {{$maildata->password}} <br><br> 
<br /><br />

<p>Please contact support at <a href="mailto:support@vimfile.com">support@vimfile.com</a> if you did not initiate this action.</p>
