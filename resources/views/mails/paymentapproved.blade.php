<html xmlns="http://www.w3.org/1999/xhtml"><head>
                                  ...
                                  <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                    <tbody><tr>
                                      <td align="center" valign="top" class="textContent">
                                        ...
                                        <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">PAYMENT ACKNOWLEDGED</h2>
    ...
    <br />Your payment on VIM File is acknowledged. </b> <br><br>Click to <a href="{{ route('AdminLogin') }}">Login</a><br><br> Thank you for choosing VIM File
    <br /><br />
