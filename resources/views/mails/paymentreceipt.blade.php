                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">PAYMENT RECEIPT FROM {{ $maildata->name }}</h2>
...
<br />You have just made the balance payment for your vehicle with VEHICLE NO: <b>{{ $maildata->licence }}</b> with  <b>{{ $maildata->name }}</b><br><br>
