                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">VIMFILE ALERT- THERE IS A NEW MOBILE MECHANICS NEAR YOU</h2>
...
<br />A new professional mechanic just joined our Auto Repair Community.<br><br>
You now have additional professional member for your Auto repair needs.
<hr />

<b>Station name:</b> {{$maildata->station_name}} <br><br>

<b>Address:</b> {{$maildata->station_address}} <br><br>
...
<b>Service Offer:</b> {{$maildata->service_offer}} <br><br>
<b>Available Discount%:</b> {{$maildata->discount}} <br><br>

<br /><br />

Check out the new online appointment that get you up to 15% discount on auto repair works. <br><br>Click to <a href="https://vimfile.com/login"><b>Login NOW</b></a> and book your next auto repair.<br><br>
