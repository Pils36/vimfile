                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">LABOUR PAYMENT INVOICE BY {{ $maildata->name }}</h2>
...
<br />Below is the labour payment invoice for the service made</b><br><br>
      ...
      <tbody>
        ...
        @if($maildata->licence != NULL)
          <tr>
              ...
              <td align='center'>{{ $maildata->licence }}</td>
          </tr>
        ...
        @if($maildata->make != NULL)
          <tr>
              <td>Make:</td>
              <td align='center'>{{ $maildata->make }}</td>
          </tr>
        ...
        @if($maildata->model != NULL)
          <tr>
              <td>Model:</td>
              <td align='center'>{{ $maildata->model }}</td>
          </tr>
        ...
        @if($maildata->date != NULL)
          <tr>
              <td>Report Date:</td>
              <td align='center'>{{ $maildata->date }}</td>
          </tr>
        @endif
        ...
        @if($maildata->service_type != NULL)
          <tr>
              <td>Service Type:</td>
              <td align='center'>{{ $maildata->service_type }}</td>
          </tr>
        @endif
        ...
        @if($maildata->service_option != NULL)
          <tr>
              ...
              <td align='center'>{{ $maildata->service_option }}</td>
          </tr>
        @endif

        @if($maildata->hour != NULL)
          <tr>
              <td>Labour Hour:</td>
              <td align='center'>{{ $maildata->hour }}</td>
          </tr>

        @endif

        @if($maildata->rate != NULL)
          <tr>
              <td>Labour Rate:</td>
              <td align='center'>{{ $maildata->rate }}</td>
          </tr>

        @endif

        @if($maildata->pay_due != NULL)
          <tr>
              <td>Labour Pay Due:</td>
              <td align='center'>{{ $maildata->pay_due }}</td>
          </tr>

        @endif

        @if($maildata->start_date != NULL)
          <tr>
              <td>Start Date:</td>
              <td align='center'>{{ $maildata->start_date }}</td>
          </tr>
        @endif

        @if($maildata->end_date != NULL)
          <tr>
              <td>End Date:</td>
              <td align='center'>{{ $maildata->end_date }}</td>
          </tr>
        @endif

        @if($maildata->deduction != NULL)
          <tr>
              <td>Deduction:</td>
              <td align='center'>{{ $maildata->deduction }}</td>
          </tr>
        @endif

        @if($maildata->balance != NULL)
          <tr>
              <td>Balance:</td>
              <td align='center'>{{ $maildata->balance }}</td>
          </tr>
        @endif

        @if($maildata->total_pay != NULL)
          <tr>
              <td>Total Payment:</td>
              <td align='center'>{{ $maildata->total_pay }}</td>
          </tr>

        @endif

        @if($maildata->cash_amount != NULL)
          <tr>
              <td>Cash Amount:</td>
              <td align='center'>{{ $maildata->cash_amount }}</td>
          </tr>
        @endif

        @if($maildata->cheque_amout != NULL)
          <tr>
              <td>Cheque Amount:</td>
              <td align='center'>{{ $maildata->cheque_amout }}</td>
          </tr>

        @endif

        @if($maildata->cheque_date != NULL)
          <tr>
              <td>Cheque Date:</td>
              <td align='center'>{{ $maildata->cheque_date }}</td>
          </tr>

        @endif

        @if($maildata->creditcard_amount != NULL)
          <tr>
              <td>Card Amount:</td>
              <td align='center'>{{ $maildata->creditcard_amount }}</td>
          </tr>
        @endif

        @if($maildata->total_amount != NULL)
          <tr>
              <td>Total Amount:</td>
              <td align='center'>{{ $maildata->total_amount }}</td>
          </tr>
        @endif
