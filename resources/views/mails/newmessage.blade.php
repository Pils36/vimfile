                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">VIMFILE ALERT- YOU HAVE A NEW MESSAGE ON VIMFILE</h2>
...
<br />You have a new message from <b>{{$maildata->sender}}. </b> <br><br> Summary is stated below:
<br /><br />
<p>Subject: <span style="font-weight: bold;">{{$maildata->subject}}</span><p> <br>

<p>Message: {!! $maildata->message !!}</p> <br> 
<br />

<a href="mailto:{{$maildata->sender}}">Click to reply {{$maildata->sender}}</a><br>
