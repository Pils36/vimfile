                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">REMINDER E-MAIL UPDATE</h2>
...
<br />Your account reminder settings are now updated by {{ $maildata->sender }}<br><br> <b>Below are your reminder updates:</b>
<br /><br />
{{$maildata->content1}} <br><br>

{{$maildata->content2}} <br><br>

{{$maildata->content3}} <br><br>

{{$maildata->content4}} <br><br> 

{{$maildata->content5}} <br><br> 
<br /><br />

<p>Please send email to <a href="mailto:support@vimfile.com">support@vimfile.com</a> if you have any concern.</p>

<p>Thank you for choosing VIM File</p>
