                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">ADDITIONAL EMAIL HAS BEEN ADDED TO YOUR VIMFILE ACCOUNT</h2>
...
<br />Additional email address have been added to your vimfile file by <b>{{ $maildata->sender }}</b><br><br> <b>Below are your added email address:</b>
<br /><br />
E-mail 1: {{$maildata->content1}} <br><br>

E-mail 2: {{$maildata->content2}} <br><br>

E-mail 3: {{$maildata->content3}} <br><br> 
<br /><br />

<p>Please reply to this mail if it was not authourised by you.</p>
