...
<br />A client with below information has booked a ticket on vimfile.com
<hr />
...
<b>Department:</b> {{$maildata->department}} <br><br>

<b>Related Services:</b> {{$maildata->relatedService}} <br><br>

<b>Message:</b> {{$maildata->message}} <br><br>

@if($maildata->document != "noImage.png")<b>Attachment:</b> <a href="https://vimfile.com/ticketing_file/{{$maildata->document}}" target="_blank">Open Document</a> <br><br>@endif
<br /><br />

Send Reply via mail to <a href="mailto:{{$maildata->email}}">{{$maildata->email}}</a>
