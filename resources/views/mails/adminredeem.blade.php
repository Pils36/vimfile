                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">REDEMPTION OF VIMFILE POINTS</h2>
...
<br />A user with the name <b>{{$maildata->name}}</b>, whose account type is <b>{{$maildata->userType}}</b> has just claimed his point on vimfile. <br><br> Details are stated below:
<br /><br />
Name: {{$maildata->name}} <br><br>

User Account: {{$maildata->userType}} <br><br>

Redeemed Points: {{$maildata->redeempoint}} <br><br> 
<br /><br />

<a href="mailto:{{$maildata->email}}">Send {{$maildata->name}} a mail</a><br><br>
