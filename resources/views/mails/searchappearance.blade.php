                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">SEARCH APPEARANCE</h2>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody><tr>
                                        <td valign="top" class="textContent">
                                          <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Hello from VIM File,</h3>

<br />Your station/company <b>{{$maildata->company}}</b>, just appeared on <a href="https://vimfile.com" style="font-weight: bold;">vimfile.com</a> <br><br>A client named <b>{{$maildata->sender}}</b> @if($maildata->city != "" || $maildata->state != "" || $maildata->state) from <b>{{$maildata->country != ""}}</b>, <b>{{$maildata->state}} {{$maildata->country}}</b> @else  ,@endif needs your service. <br><br> Kindly <a href="https://vimfile.com/register?c=business" style="font-weight: bold;">Register</a> today to enjoy more with vimfile.
<br /><br />
