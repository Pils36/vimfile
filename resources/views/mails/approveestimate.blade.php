                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">YOUR PAYMENT ON VIMFILE HAS BEEN APPROVED</h2>
...
<br />{{ $maildata->message }}. </b> <br><br>Click to <a href="https://vimfile.com/login">Login</a>
<br /><br />
