...
<head>
    ...
    <title>Vehicle Inspection & Maintenance File</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left" style="padding:0;Margin:0;">
                                                                    <p
                                                                        ...
                                                                        There is a new post on vimfile.com <a
                                                                            href="https://vimfile.com"
                                                                            title="vimfile.com">vimfile.com</a> <br><br>
                                                                        Subject: <b>{{ $maildata->subject }}</b></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr style="border-collapse:collapse;">
                                                    <td width="560" align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left" style="padding:5;Margin:5;">
                                                                    <p
                                                                        style="Margin:5;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">
                                                                        Kindly login to read this post</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left" style="padding:5;Margin:5;">
                                                                    <p
                                                                        style="Margin:5;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">
                                                                        <a type="button"
                                                                            href="https://vimfile.com/Newsandhapenings"
                                                                            style="text-decoration: none; padding: 7px; color: #fff; background-color:darkorange; border-radius: 10px;">Click
                                                                            the button to login and read post</a></p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left" style="padding:5;Margin:5;">
                                                                    <p
                                                                        ...
                                                                        Thanks<br>
                                                                        Vimfile Team<br>
                                                                        <a href="mailto:info@vimfile.com">E:
                                                                            info@vimfile.com</a></p>
