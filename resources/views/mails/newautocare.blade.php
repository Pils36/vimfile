                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">VIMFILE ALERT. A PROFESSIONAL MECHANICS NEAR YOUR LOCATION JUST JOINED VIMFILE COMMUNITY.</h2>
...
<br />A new professional mechanic just joined our Auto Repair Community. <br><br> You now have additional professional member for your Auto repair needs.
<hr />

<b>Company Name:</b> {{$maildata->mechanic}} <br><br>

<b>Station name:</b> {{$maildata->station_name}} <br><br>

<b>Address Near You:</b> {{$maildata->station_address}} <br><br>

<b>City:</b> {{$maildata->city}} <br><br>
<b>State:</b> {{$maildata->state}} <br><br>
<b>Postal/Zip Code:</b> {{$maildata->zipcode}} <br><br>

<b>Country:</b> {{$maildata->country}} <br><br>
<b>Services Offer:</b> {{$maildata->service_offer}} <br><br>
<b>Available Discount (%):</b> {{$maildata->discount}} <br><br>

<br /><br />

Check out the new online appointment that get you up to 15% discount on auto repair works. <br>Click to <a href="https://vimfile.com/login"><b>Login NOW</b></a> and book your next auto repair<br><br>
