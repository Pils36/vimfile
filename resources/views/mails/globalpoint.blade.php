                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    ...
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">BE A GLOBAL PLAYER WITH VIMFILE. EARN ACHIEVEMENTS POINTS</h2>
...
<br />We are pleased to notify you that you have earned yourself {{$maildata->point}} point(s) this month on <a href="https://vimfile.com/login">vimfile.com</a>. 
<br />You can earn more points by being active in using tools on vimfile. Click the <a href="https://vimfile.com/ranking">link</a> to know how you can earn more points.
<br>
<br>
Thank you for choosing vimfile<br>
