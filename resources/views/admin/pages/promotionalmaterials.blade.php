    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
            ...
            <form action="{{ route('promotionupload') }}" method="post" enctype="multipart/form-data">
            @csrf
                <h5 class="box-title">Material Title</h5>
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" name="title" id="title" class="form-control" placeholder="Material Title" required>
                    </div>
                </div>
