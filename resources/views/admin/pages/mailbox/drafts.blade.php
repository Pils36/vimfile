            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                      @if (count($draftMail) > 0)
                          @foreach ($draftMail as $item)
                              <tr>
                                ...
                                <td class="mailbox-subject"><b><?php $string = $item->message; $output = strlen($string) > 20 ? substr($string,0,20)."..." : $string;?>
                          ...
                          @endforeach
                      @else
                          <tr><td colspan="6" align="center">No draft message</td></tr>
                      @endif
