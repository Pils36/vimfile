            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="company">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="company_name" placeholder="Company Name" value="{{ $profileDetails[0]['station_name'] }}" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="hidden" name="email" id="company_email" value="{{ $profileDetails[0]['email'] }}">
              ...
              <div class="tab-pane" id="contact">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="hidden" name="email" id="contact_email" value="{{ $profileDetails[0]['email'] }}">
              ...
              <div class="tab-pane" id="speciality">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="hidden" name="email" id="speciality_email" value="{{ $profileDetails[0]['email'] }}">
              ...
              <div class="tab-pane" id="value">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="hidden" name="email" id="value_email" value="{{ $profileDetails[0]['email'] }}">
              ...
              <div class="tab-pane" id="amenity">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="hidden" name="email" id="amenity_email" value="{{ $profileDetails[0]['email'] }}">
              ...
              <div class="tab-pane" id="history">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="hidden" name="email" id="history_email" value="{{ $profileDetails[0]['email'] }}">
              ...
              <div class="tab-pane" id="managephotos">
                <form class="form-horizontal" action="{{ route('updatephoto') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="hidden" name="busID" value="{{ $profileDetails[0]['busID'] }}">
                        <input type="hidden" name="email" value="{{ $profileDetails[0]['email'] }}">
              ...
              <div class="tab-pane" id="serviceoffer">
                <form class="form-horizontal" action="{{ route('serviceoffered') }}" method="POST" id="service_form">
                    ...
                    <div class="col-sm-10">
                      @if($servicecheck = \App\User::where('email', $profileDetails[0]['email'])->get())
