  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header bg-blue">
              <h3 class="box-title" style="text-transform: uppercase; font-weight: bolder;">JOB DONE AND SATISFIED BY CLIENTS</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        @if(count($jobdone) > 0)
          <h2>All Posts</h2> <hr>
              <table id="example7" class="table table-bordered table-striped">
               ...
               <h4 class="text-center">No jobs done yet</h4>
