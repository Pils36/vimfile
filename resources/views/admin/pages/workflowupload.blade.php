    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Upload Workflow | <a href="{{ route('uploaded workflow') }}" style="text-decoration: underline">View uploaded workflows</a></h3>
        ...
        <div class="box-body">
            ...
            <form action="{{ route('uploadworkflow') }}" method="post" enctype="multipart/form-data">
            @csrf
                <h5 class="box-title">Workflow Title</h5>
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" name="title" id="title" class="form-control" placeholder="Workflow Title" required>
                    </div>
                </div>
