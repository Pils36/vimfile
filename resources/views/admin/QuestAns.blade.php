          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              @if (count($getAns) > 0)
                ...
                <tbody>
                  <?php $i = 1;?>
                  @foreach ($getAns as $getAnswer)
                     <tr>
                      <td>{{ $i++ }}</td>
                      <td>{{ $getAnswer->question }}</td>
                      <td>{{ $getAnswer->service_type }}</td>
                      <td>{{ $getAnswer->answer }}</td>
                      <td><a href="/expertupload/{{ $getAnswer->image }}"><img src="/expertupload/{{ $getAnswer->image }}" style="width: 50px; height: 50px;"></a></td>
                      <td><button title="View question" onclick="quest('{{ $getAnswer->id }}','viewpost')" style="background: none;"><span class="label pull-left"><img src="https://img.icons8.com/dusk/50/000000/view-file.png" style="width: 15px; height: 15px;"></span></button><button title="Delete question" onclick="quest('{{ $getAnswer->id }}','delpost')" style="background: none;"><span class="label pull-right"><img src="https://img.icons8.com/color/48/000000/delete-sign.png" style="width: 15px; height: 15px;"></span></button></td>
                    </tr>
                  @endforeach
                ...
                <p class="text-center">No Answers to this questions</p>
