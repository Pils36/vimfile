        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">All Maintenance Records</h3>
              <!-- tools box -->
            ...
            <div class="box-body">
              ...
              @if (count($maintRec) > 0)
                ...
                <tbody>
                  <?php $i = 1;?>
                  @foreach ($maintRec as $maintRecs)
                     <tr>
                      <td>{{ $i++ }}</td>
                      <td>{{ $maintRecs->date }}</td>
                      <td>{{ $maintRecs->vehicle_licence }}</td>
                      <td>{{ $maintRecs->make }}</td>
                      <td>{{ $maintRecs->model }}</td>
                      <td>{{ $maintRecs->service_type }}</td>
                      <td>{{ $maintRecs->service_option }}</td>
                      <td>{{ $maintRecs->total_cost }}</td>
                      <td>{{ $maintRecs->update_by }}</td>
                      @if($coy = \App\Business::where('busID', $maintRecs->busID)->get())
                      @if(count($coy) > 0)
                ...
                <p class="text-center">There are no recorded maintenance</p>
