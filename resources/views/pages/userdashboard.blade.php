...
.reviewcon {
    ...
    padding: 15px;
    border-radius: 10px;
    -webkit-box-shadow: 4px 6px 15px -5px rgba(77,37,10,0.83);
    -moz-box-shadow: 4px 6px 15px -5px rgba(77,37,10,0.83);
    box-shadow: 4px 6px 15px -5px rgba(77,37,10,0.83);
    height: 100vh;
    max-height: 100%;
}
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="phoneappointment-tab" data-toggle="tab" href="#phoneappointment" role="tab" aria-controls="phoneappointment" aria-selected="false">Phone Appointment List</a>
  </li>
                    ...
                    {{-- Start Posted Opportunities --}}
                        ...
                        <div class="row item-list">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="opportunitycontain">

                                    <div class="row">
                                        <div class="col-2">
                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ4KcIqXiEAW0w28LMwALg11W_yN1wqkh0H3Pqeb4Mp3i4Tkjw7" class="opport-image">
                                        </div>
                                        <div class="col-10">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <h6>Service type: <b>{{ $opportunity->post_subject }}</b></h6><br>
                                                    <h6>Service Option: <b>{{ $opportunity->service_option }}</b></h6><br>
                                                    <h6>Make / Model: <b>{{ $opportunity->post_make.' / '.$opportunity->post_model }}</b></h6><br>
                                                </div>
                                                <div class="col-md-5">
                                                    <h6>Previous Mileage: <b>{{ $opportunity->post_mileage }}</b></h6><br>
                                                    <h6>Current Mileage: <b>{{ $opportunity->post_curr_mileage }}</b></h6><br>
                                                    <h6>Year: <b>{{ $opportunity->post_year }}</b></h6><br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="post_info">
                                            ...
                                            <br>{!! $opportunity->post_description !!}<hr>
                                ...
                                <h6 style="font-weight: 600">REPAIR LOCATION INFORMATION</h6> <br>

                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Address: <p style="text-align: justify; font-size: 13px;"><a href="https://www.google.ng/maps/place/{{ $opportunity->post_service_need }}" target="_blank" style="color: navy; font-weight: bold; text-decoration: underline;">{{ $opportunity->post_service_need }}</a></p>
                                        </h6><br>

                                        <h6>City: <p style="text-align: justify; font-size: 13px;">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h6>State: <p style="text-align: justify; font-size: 13px;">
                                            {{ $opportunity->poststate }}
                                        </p></h6><br>

                                        <h6>Zipcode: <p style="text-align: justify; font-size: 13px;">
...
@endif
  ...
  <div class="tab-pane fade" id="phoneappointment" role="tabpanel" aria-labelledby="phoneappointment-tab">
      {{-- Start Phone Appointment --}}

      <div class="card-body">
        <div class="itembody">

            @if(count($phoneappointment) > 0)
            ...
            {{-- Start Posted Opportunities --}}
                ...
                <div class="row item-list">
                    ...
                    @foreach($phoneappointment as $opportunity)
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="opportunitycontain">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <img src="https://cdn4.iconfinder.com/data/icons/shopping-kalor/142/24hours-512.png" class="opport-image">
                                </div>
                                <div class="col-10">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <h6>Service type: <b>{{ $opportunity->service_type }}</b></h6><br>
                                            <h6>Service Option: <b>{{ $opportunity->service_option }}</b></h6><br>
                                            <h6>Call Date: <b>{{ date('d-m-Y', strtotime($opportunity->date_of_visit)) }}</b></h6><br>
                                        </div>
                                        <div class="col-md-5">
                                            <h6>Customer's Name: <b>{{ $opportunity->name }}</b></h6><br>

                                            @if($user = \App\User::where('email', $opportunity->email)->get())

                                                @if (count($user) > 0)
                                                    <h6>Customer's Phone: <a href="tel: {{ $user[0]->phone_number }}"><b>{{ $user[0]->phone_number }}</b></a></h6><br>
                                                    
                                                @else
                                                    <h6>Customer's Phone: <b>-</b></h6><br>
                                            ...
                                            <h6>Customer's Email: <b>{{ $opportunity->email }}</b></h6><br>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <h5 style="color: red; font-weight: bold; text-align: center;">No recorded phone appointment</h5>
  ...
  <div class="tab-pane fade show active" id="appointment" role="tabpanel" aria-labelledby="appointment-tab">
      ...
      @if(count($myBookings) > 0)
            ...
            <div class="row">
                ...
                {{-- <div class="col-md-12">
                    <img src="https://www.vippng.com/png/detail/67-676803_img-book-an-appointment-button.png" alt="header" style="max-height: 150px; width: 100%;">
                </div> --}}
                ...
                @foreach($myBookings as $myBooking)
                    ...
                    <div class="contDes">
                        <div class="row">
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/cotton/20/000000/ticket.png"/> Booking Code</h4>
                                <p>{{ $myBooking->ref_code }}</p>
                            </div>
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/color/20/000000/pay-date.png"/> Appointment Date</h4>
                                <p>{{ date('d-M-Y', strtotime($myBooking->date_of_visit)) }}</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/color/20/000000/driver-license-card.png"/> Vehicle Licence</h6>
                                <p>{{ $myBooking->vehicle_reg_no }}</p>
                            </div>
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/officel/20/000000/percentage.png"/> Expected Discount</h6>
                                <p>{{ $discountcharge }}</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/color/20/000000/email.png"/> Client Email</h6>
                                <p>{{ $myBooking->email }}</p>
                            </div>
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/dusk/20/000000/cell-phone.png"/> Client Phone</h6>
                                <p>{{ $myBooking->telephone }}</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/dusk/20/000000/car-service.png"/> Service Option</h6>
                                <p>{{ $myBooking->service_option }}</p>
                            </div>
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/color/20/000000/tire-iron.png"/> Service Type</h6>
                                <p>{{ $myBooking->service_type }}</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/office/20/000000/likes-folder.png"/> Vehicle Make</h6>
                                <p>{{ $myBooking->make }}</p>
                            </div>
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/color/20/000000/module.png"/> Vehicle Model</h6>
                                <p>{{ $myBooking->model }}</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/officel/20/000000/maximum-speed.png"/> Current Mileage</h6>
                                <p>{{ $myBooking->current_mileage }}</p>
                            </div>
                            <div class="col-md-6">
                                <h6><img src="https://img.icons8.com/color/20/000000/2020-year.png"/> Year</h6>
                                <p>{{ $myBooking->year_owned_since }}</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-12">
                                <h6><img src="https://img.icons8.com/cotton/20/000000/new-message.png"/> Description</h6>
                                <p>{!! $myBooking->message !!}</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-4">
                                <button title="Check IVIM" style="font-size: 12px; margin-top: 10px;" class="btn btn-primary btn-block" onclick="clientIvim('{{ $myBooking->vehicle_reg_no }}')">Check IVIM </button>
                            </div>
                            <div class="col-md-4">
                                <button title="Prepare Estimate" style="font-size: 12px; margin-top: 10px;" class="btn btn-success btn-block" onclick="newprepareEstimate('{{ $myBooking->ref_code }}', '{{ $myBooking->email }}', '{{ Auth::user()->ref_code }}')">Prepare Estimate <img class="spinnernewprepestimate{{ $myBooking->ref_code }} disp-0" src="{{ asset('img/loader/spin.gif') }}" style="width: 30px; height: 30px;"></button>
                            </div>

                            {{-- <div class="col-md-3">

                                <button title="Phone Appointment" style="font-size: 12px; margin-top: 10px;" class="btn btn-info" onclick="phoneAppointment('{{ $myBooking->email }}', '{{ $myBooking->ref_code }}')">Phone Appointment <img class="phoneappointspin{{ $myBooking->ref_code }} disp-0" src="{{ asset('img/loader/spin.gif') }}" style="width: 30px; height: 30px;"></button>
                            </div> --}}

                            <div class="col-md-4">
                                <button title="Visit took place" style="font-size: 12px; margin-top: 10px;" class="btn btn-danger btn-block" onclick="visittookPlace('{{ $myBooking->ref_code }}')">Close Appointment <img class="spinnertookplace{{ $myBooking->ref_code }} disp-0" src="{{ asset('img/loader/spin.gif') }}" style="width: 30px; height: 30px;"></button>
                            </div>
        ...
        <h2 style="text-align: center">No appointment here yet</h2>
            ...
            <div class="col-md-6">
                ...
                <div class="reviewcon">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            {{-- Review Content Service Quality --}}
                            <h5>Quality of Service ({{ $myreview->rating }})</h5>
                            <small>
                                @for ($i = 1; $i <= $myreview->rating; $i++)
                                    <img src="https://img.icons8.com/fluent/15/000000/christmas-star.png"/>
                                @endfor
                                
                            </small>
                           <p style="color: navy; font-weight: bold;"> Review by: @if($user = \App\User::where('ref_code', $myreview->ref_code)->get()) @if(count($user) > 0) <?php echo substr($user[0]->name, 0, -10) . "****";?> @else Anonymous @endif  @endif </p>
        
                            <p> Time: {{ $myreview->created_at->diffForHumans() }} {{ date('h:i A', strtotime($myreview->created_at)) }} </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div @if(strlen($myreview->comment) >= 700) class="reviewreply" @else class="reviewothereply" @endif>
                                {!! $myreview->comment !!}
                            </div>
                        </div>
                    </div>
                ...
                <div class="row review_reply{{ $myreview->id }} disp-0">
                    <div class="col-md-12">
                            <p style="font-weight: bold;">Send a reply</p>
...
<div class="card">
  ...
  <div class="tab-pane fade" id="appointmentonphone" role="tabpanel" aria-labelledby="appointmentonphone-tab">

    {{-- Coming Soon --}}
    <div class="itemListing" style="padding: 50px;">

        <div class="row">

            <form action="{{ route("phoneappointment") }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12"><label for="date_of_visit">Date of Visit</label>
                            <input type="date" name="date_of_visit" id="date_of_visit" class="form-control"></div>
            
                        <br><br>
            
                        <div class="col-md-12"><label for="service_option">Service Option</label><select name="service_option" id="service_option" class="form-control"><option value="Major Repair">Major Repair</option><option value="Minor Repair">Minor Repair</option><option value="Scheduled Maintenance">Scheduled Maintenance</option><option value="Emergency Maintenance">Emergency Maintenance</option></select></div>
            
                        <br><br>
            
                        <div class="col-md-12">
                            <label for="my_service_type">Service Type</label>
                            <select name="my_service_type" id="my_service_type" class="form-control">
                                <option value="Service" selected="selected" disabled="disabled">Service</option>
                        ...
                        <div class="col-md-12"><label for="current_mileage">Current Mileage</label><input type="text" name="current_mileage" id="my_current_mileage" class="form-control"></div>
            
                        <br><br>
            
                        <div class="col-md-12"><label for="my_message">Appointment Discussion</label><textarea class="form-control" name="my_message" id="my_message" placeholder="Enter Message" style="height: 150px; resize: none;"></textarea></div>
                        ...
                        <br><br>
                            ...
                            <button type="submit" class="btn btn-primary" style="width: 100%;">Submit</button></div></div></form>
  ...
  <div class="tab-pane fade" id="vinlookup" role="tabpanel" aria-labelledby="vinlookup-tab">
    ...
    <div class="itemListing" style="padding: 50px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <center>
                    <button class="btn btn-primary btn-block" onclick="lookupVin()">VIN Look Up <img class="spinnerlookup disp-0" src="{{ asset('img/loader/spin.gif') }}" style="width: 30px; height: 30px;"></button>
                </center>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3>
                    This feature is only available to paid users. <a href="{{ route('Pricing') }}" type="button" class="btn btn-info">Upgrade today</a>
                </h3>
            </div>
