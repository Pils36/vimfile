    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <form class="form-contact contact_form" action="#" method="post" id="contactForm"
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="stationname" id="stationname" value="{{ Auth::user()->station }}">
            ...
            <div class="form-group mt-3">
              <button type="button" class="button button-monerisForm btn_2" onclick="monerisPayinstore()" style="width: 100%;">Make Payment <img class="spinnerMonerisinstore disp-0" src="{{ asset('img/loader/spin.gif') }}" style="width: 30px; height: 30px;"> <i class="fas fa-credit-card"></i> </button>
            </div>
          </form>
        ...
        @else
          ...
          <h2 style="text-align: center">Cannot make payment. Estimate code not available</h2>
